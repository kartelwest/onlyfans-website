...
type ModelNote = {
    ...
    /** Staff shared this note with the model's representative. */
    repVisible: boolean;
...
export default function NotesTab({
    ...
    // Sharing a note with the representative is an access decision, so it
    // stays with staff. guard_note_rep_visible enforces the same thing.
    const canShareWithRep =
        permissions.canShareWithRep ??
        (currentUserRole === "owner" ||
            currentUserRole === "administrator");
